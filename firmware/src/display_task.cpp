  ...
  while (1)
  {
    ...
    else
    {
      ...
      else if (strncmp(state.config.text, "SKDEMO_Menu", 11) == 0)
      {
        ...
        if (state.current_position < 0)
        {
          position_for_menu_calc = 400 + state.current_position;
        }

        uint8_t menu_item = position_for_menu_calc % 4;
        ...
        case 1:
          ...
          // right one
          spr_.drawBitmap(center_h + icon_size_active / 2 + 20, center_v - icon_size_inactive / 2 - offset_vertical, lamp_regular_40, icon_size_inactive, icon_size_inactive, color_inactive, background);
        ...
        case 2:
          // lamp
          color_active = spr_.color565(245, 167, 66);
          ...
          spr_.drawBitmap(center_h - icon_size_active / 2, center_v - icon_size_active / 2 - offset_vertical, lamp_solid, icon_size_active, icon_size_active, color_active, background);
          ...
          spr_.setTextColor(color_active);
          spr_.setFreeFont(&Roboto_Thin_24);
          spr_.drawString("Light", center_h, center_v + icon_size_active / 2 + 30 - offset_vertical, 1);
        ...
        case 3:
          ...
          // left one
          spr_.drawBitmap(center_h - icon_size_active / 2 - 20 - icon_size_inactive, center_v - icon_size_inactive / 2 - offset_vertical, lamp_regular_40, icon_size_inactive, icon_size_inactive, color_inactive, background);
