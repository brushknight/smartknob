    ...
    else
    {
      ...
      else if (strncmp(state.config.text, "SKDEMO_Menu", 11) == 0)
      {
        ...
        case 0:
          ...
          // // bright circle 2px left
          // spr_.drawCircle(center_h - room_lable_w / 2, label_vertical_offset + room_lable_h / 2, room_lable_h / 2, color_active);
          // spr_.drawCircle(center_h - room_lable_w / 2, label_vertical_offset + room_lable_h / 2, room_lable_h / 2 - 1, color_active);

          // // bright circle 2px right
          // spr_.drawCircle(center_h + room_lable_w / 2, label_vertical_offset + room_lable_h / 2, room_lable_h / 2, color_active);
          // spr_.drawCircle(center_h + room_lable_w / 2, label_vertical_offset + room_lable_h / 2, room_lable_h / 2 - 1, color_active);
          ...
          // // top line 2 px
          // spr_.drawLine(center_h - room_lable_w / 2, label_vertical_offset, center_h + room_lable_w / 2, label_vertical_offset, color_active);
          // spr_.drawLine(center_h - room_lable_w / 2, label_vertical_offset + 1, center_h + room_lable_w / 2, label_vertical_offset + 1, color_active);

          // // bottom line 2px
          // spr_.drawLine(center_h - room_lable_w / 2, label_vertical_offset + room_lable_h, center_h + room_lable_w / 2, label_vertical_offset + room_lable_h, color_active);
          // spr_.drawLine(center_h - room_lable_w / 2, label_vertical_offset + room_lable_h + 1, center_h + room_lable_w / 2, label_vertical_offset + room_lable_h + 1, color_active);

          spr_.setTextColor(TFT_BLACK);
          spr_.setFreeFont(&Roboto_Thin_Bold_24);
          spr_.drawString("Kitchen", center_h, label_vertical_offset + room_lable_h / 2 - 1, 1);
      ...
      else if (app_state.ui_id == 6)
      {
        ...
        spr_.drawBitmap(40, 75, wifi_40, wifi_icon_size, wifi_icon_size, TFT_WHITE, TFT_BLACK);

        // wifi_30

        IPAddress ip = IPAddress(10, 0, 8, 27);
        std::string SSID = "Brushknight IoT";
        int16_t signal_strength = -27;
        std::string signal_strength_text = "Good";

        char buf_[24];
        spr_.setTextColor(TFT_GREEN);
        spr_.setFreeFont(&Roboto_Thin_20);
        spr_.drawString(signal_strength_text.c_str(), center_h, 93, 1);

        spr_.setTextColor(TFT_WHITE);
        spr_.setFreeFont(&Roboto_Thin_20);
        sprintf(buf_, "%ddb", signal_strength);
        spr_.drawString(buf_, center_h + 65, 93, 1);
